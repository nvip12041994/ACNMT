...
def cli_main(
    ...
    generator_option = ['data-bin_vi_en/iwslt15.tokenized.vi-en',
                        ...
                        '--no-progress-bar',
                        '--bpe', 'subword_nmt',
                        '--bpe-codes', 'data-bin_vi_en/bpe_code',
                        '--eval-bleu',
                        ...
                        '--restore-file', 'checkpoints/transformer_base_vi_en/checkpoint_best.pt',
                        '--update-freq', '1',
                        '--keep-best-checkpoints', '1',
                        '--save-dir', 'checkpoints/transformer_base_vi_en']
