...
def cli_main():
    ...
    data_raw = "/home/s1910443/experiment/investigate/new_data/wmt17_en_de"
    generator_option = ['--source-lang', 'en',
                        '--target-lang', 'de',
                        '--trainpref', '{}/train'.format(data_raw),
                        '--validpref', '{}/valid'.format(data_raw),
                        '--testpref', '{}/test'.format(data_raw),
                        '--destdir', 'data-bin/wmt17_en_de',
                        '--workers', '20']
    args = parser.parse_args(generator_option)
    main(args)
