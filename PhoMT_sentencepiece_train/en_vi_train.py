...
def cli_main(
    ...
    generator_option = ['data-bin/PhoMT_sentencepiece.tokenized.en-vi',
                        '--arch', 'transformer',
                        ...
                        '--log-format', 'json' ,
	                    '--log-interval', '100' ,
                        '--log-file', 'PhoMT_en_vi.log',

                        '--restore-file', 'checkpoints/transformer_PhoMT_en_vi/checkpoint_best.pt',
                        '--update-freq', '1',
                        '--keep-best-checkpoints', '1',
                        #'--no-epoch-checkpoints',
                        '--save-dir', 'checkpoints/transformer_PhoMT_en_vi']
