...
def cli_main(
    ...
    generator_option = ['data-bin/PhoMT.tokenized.en-vi',
                        #'--arch', 'transformer',
                        ...
                        '--restore-file', 'checkpoints/transformer_big_PhoMT_en_vi/checkpoint_best.pt',
                        '--update-freq', '1',
                        '--keep-best-checkpoints', '1',
                        #'--no-epoch-checkpoints',
                        '--save-dir', 'checkpoints/transformer_big_PhoMT_en_vi']
