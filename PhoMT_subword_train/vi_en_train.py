...
def cli_main(
    ...
    generator_option = ['data-bin/PhoMT.tokenized.vi-en',
                        #'--arch', 'transformer',
                        ...
                        '--log-format', 'json' ,
	                    '--log-interval', '100' ,
                        '--log-file', 'PhoMT_vi_en_big.log',

                        #'--bpe', 'subword_nmt',
                        #'--bpe-codes', 'data-bin/iwslt15.tokenized.en-vi/bpe_code',
                        #'--eval-bleu',
                        ...
                        #'--restore-file', 'checkpoints/transformer_base_PhoMT_vi_en/checkpoint_best.pt',
                        '--restore-file', 'checkpoints/transformer_big_PhoMT_vi_en/checkpoint_best.pt',
                        '--update-freq', '1',
                        '--keep-best-checkpoints', '1',
                        #'--no-epoch-checkpoints',
                        '--save-dir', 'checkpoints/transformer_big_PhoMT_vi_en']
                        #'--save-dir', 'checkpoints/transformer_base_PhoMT_vi_en']
