...
def cli_main():
    cur_model = ['./data-bin/PhoMT.tokenized.vi-en/','--beam','5', '--path', '','--bpe', 'subword_nmt', '--bpe-codes', './data-bin/PhoMT.tokenized.vi-en/bpe_code', '--sacrebleu', '--quiet']
    #filenames = next(walk('checkpoints/transformer_base_PhoMT_vi_en/'), (None, None, []))[2]
    filenames = next(walk('checkpoints/transformer_big_PhoMT_vi_en/'), (None, None, []))[2]
    ...
    for i in range(len(filenames)):
        ...
        if "checkpoint" in filenames[i]:
            cur_model[4] = 'checkpoints/transformer_big_PhoMT_vi_en/' + filenames[i]
