...
class BaseRanker(nn.Module):
    def __init__(self, args, task):
        ...
        self.separator_token = task.source_dictionary.eos()
    ...
    def __init__(self, args, task):
        ...
        if False:
            ...
            self.model = TransformerSentenceEncoder(
                ...
                vocab_size=len(task.source_dictionary) + len(task.target_dictionary),
                ...
                max_seq_len=task.cfg.max_source_positions,
                num_segments=2,
                offset_positions_by_padding=False,
...
class DiscriminativeNMTReranker(nn.Module):
    # @classmethod
    ...
    def __init__(self, task, args):
        ...
        self.model = BertRanker(args = args, task = task)
