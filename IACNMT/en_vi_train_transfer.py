...
def cli_main(
    ...
    generator_option = ['data-bin/iwslt15_PhoMT_bpe.tokenized.en-vi',
                        '--arch', 'transformer',
                        ...
                        '--log-format', 'json' ,
	                    '--log-interval', '100' ,
                        '--log-file', 'PhoMT_en_vi_base_2.log',
                        ...
                        '--restore-file', 'checkpoints/transformer_base_PhoMT_en_vi/checkpoint_best.pt',
                        '--update-freq', '1',
                        '--keep-best-checkpoints', '1',
                        #'--no-epoch-checkpoints',
                        '--save-dir', 'checkpoints/transformer_base_iwlst15_PhoMT_bpe_en_vi']
